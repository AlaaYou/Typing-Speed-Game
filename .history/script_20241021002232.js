document.addEventListener("DOMContentLoaded", () => {
  ...
  //Text to display
  const sampleTexts = ["apple", "ocean", "dream", "light", "friend",
  "music", "forest", "journey", "magic", "time",
  "sunshine", "whisper", "adventure", "river", "harmony",
  "inspire", "travel", "mountain", "candle", "soul",
  "freedom", "laughter", "echo", "star", "courage",
  "peace", "wildflower", "heartbeat", "cloud", "wisdom",
  "sunset", "echo", "serenity", "joy", "wonder"];
